...
Após importar a base de dados, vou escolher 6 séries que servirão para fazer uma análise bem interessante sobre sua avaliação de acordo com o IMDB.
...
**1. Qual das séries que eu escolhi é mais bem avaliada no IMDB? A diferença é grande? Pequena?**
  ...
  * A nossa base de dados fornece inúmeras variáveis que podem ser analisadas a fim de responder essa pergunta. Os dados estão agrupados da seguinte forma: Cada episódio da série tem uma nota, então podemos analisar a média ou mediana das notas dos episódios a fim de saber qual possui a maior nota e, dessa forma, descobrir qual a série mais bem avaliada. Nesse caso utilizaremos a mediana.    
